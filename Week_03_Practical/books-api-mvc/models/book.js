...
//this is json not a list for the class
const books = [
...
class Book {
  ...
  static async getBookById(id) {
    ...
    const book = books.find((book) => book.id === id);  //callback function 
    return book;
  }

  static async createBook(newBookData) {
    const books = await this.getAllBooks(); // Await the promise to get books  //this refer to the current object which is running 
